...
export class SideBarComponent extends AppComponentBase {
    ...
    menu: SideBarMenu = new SideBarMenu('MainMenu', 'MainMenu', [
        ...
        new SideBarMenuItem('Employees', '', 'icon-globe', '/app/main/employees'),

        new SideBarMenuItem('EmployeesModule', '', 'icon-globe', '/app/module-employee/employees'),

        new SideBarMenuItem('Tasks', '', 'icon-globe', '/app/main/tasks'),
