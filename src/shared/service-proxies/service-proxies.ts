...
export class EmployeeServiceProxy {
    ...
    protected processCreate(response: Response): Observable<EmployeeDto> {
        const status = response.status; 
     ...
     * @return Success
     */
    del(id: number): Observable<number> {
        let url_ = this.baseUrl + "/api/services/app/Employee/Del?";
        if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processDel(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processDel(response_);
    ...
    protected processDel(response: Response): Observable<number> {
        const status = response.status; 
     ...
     * @return Success
     */
    edit(empl: EmployeeDto): Observable<EmployeeDto> {
        let url_ = this.baseUrl + "/api/services/app/Employee/Edit";
        url_ = url_.replace(/[?&]$/, "");

        const content_ = JSON.stringify(empl);
    ...
    protected processEdit(response: Response): Observable<EmployeeDto> {
        const status = response.status; 
    ...
    checkName(name: string): Observable<boolean> {
        let url_ = this.baseUrl + "/api/services/app/Employee/CheckName?";
        if (name !== undefined)
    ...
    protected processCheckName(response: Response): Observable<boolean> {
        const status = response.status; 
     ...
     * @return Success
     */
    getListIgonre(name: string): Observable<ListResultDtoOfEmployeeListDto> {
        let url_ = this.baseUrl + "/api/services/app/Employee/GetListIgonre?";
        if (name !== undefined)
            url_ += "name=" + encodeURIComponent("" + name) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processGetListIgonre(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processGetListIgonre(response_);
    ...
    protected processGetListIgonre(response: Response): Observable<ListResultDtoOfEmployeeListDto> {
        const status = response.status; 
     ...
     * @return Success
     */
    checkIgnoreName(name1: string, name2: string): Observable<boolean> {
        let url_ = this.baseUrl + "/api/services/app/Employee/CheckIgnoreName?";
        if (name1 !== undefined)
            url_ += "name1=" + encodeURIComponent("" + name1) + "&"; 
        if (name2 !== undefined)
            url_ += "name2=" + encodeURIComponent("" + name2) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            return this.processCheckIgnoreName(response_);
        }).catch((response_: any) => {
            if (response_ instanceof Response) {
                try {
                    return this.processCheckIgnoreName(response_);
    ...
    protected processCheckIgnoreName(response: Response): Observable<boolean> {
        const status = response.status; 
     ...
     * @return Success
     */
    check(employee: CheckEmployee, status: boolean): Observable<boolean> {
        let url_ = this.baseUrl + "/api/services/app/Employee/Check?";
        if (status !== undefined)
    ...
    protected processCheck(response: Response): Observable<boolean> {
        const status = response.status; 
     ...
     * @return Success
     */
    getAll(input: string): Observable<ListResultDtoOfEmployeeListDto> {
...
export class TaskServiceProxy {
     ...
     * @return Success
     */
    create(input: CreateTaskInput): Observable<CreateTaskInput> {
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            ...
            if (response_ instanceof Response) {
                try {
                    ...
                    return <Observable<CreateTaskInput>><any>Observable.throw(e);
                }
            } else
                return <Observable<CreateTaskInput>><any>Observable.throw(response_);
        });
    }

    protected processCreate(response: Response): Observable<CreateTaskInput> {
        const status = response.status; 
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? CreateTaskInput.fromJS(resultData200) : new CreateTaskInput();
            return Observable.of(result200);
        } else if (status !== 200 && status !== 204) {
            const _responseText = response.text();
            return throwException("An unexpected server error occurred.", status, _responseText, _headers);
        }
        return Observable.of<CreateTaskInput>(<any>null);
    }
     ...
     * @return Success
     */
    edit(input: CreateTaskInput): Observable<CreateTaskInput> {
        let url_ = this.baseUrl + "/api/services/app/Task/Edit";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processEdit(response: Response): Observable<CreateTaskInput> {
        const status = response.status; 
     ...
     * @return Success
     */
    getAll1(taskState: TaskState): Observable<ListResultDtoOfTaskListDto> {
    ...
    protected processGetAll1(response: Response): Observable<ListResultDtoOfTaskListDto> {
        const status = response.status; 
     ...
     * @return Success
     */
    getAll(taskState: TaskState2): Observable<ListResultDtoOfTaskEmployeeDto> {
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            ...
            if (response_ instanceof Response) {
                try {
                    ...
                    return <Observable<ListResultDtoOfTaskEmployeeDto>><any>Observable.throw(e);
                }
            } else
                return <Observable<ListResultDtoOfTaskEmployeeDto>><any>Observable.throw(response_);
        });
    }

    protected processGetAll(response: Response): Observable<ListResultDtoOfTaskEmployeeDto> {
        const status = response.status; 
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? ListResultDtoOfTaskEmployeeDto.fromJS(resultData200) : new ListResultDtoOfTaskEmployeeDto();
            return Observable.of(result200);
        } else if (status !== 200 && status !== 204) {
            const _responseText = response.text();
            return throwException("An unexpected server error occurred.", status, _responseText, _headers);
        }
        return Observable.of<ListResultDtoOfTaskEmployeeDto>(<any>null);
    }

    /**
     * @return Success
     */
    getId(id: number): Observable<CreateTaskInput> {
        let url_ = this.baseUrl + "/api/services/app/Task/GetId?";
        if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetId(response: Response): Observable<CreateTaskInput> {
        const status = response.status; 
...
export class EmployeeListDto implements IEmployeeListDto {
    ...
    toJSON(data?: any) {
        ...
        data["completeTask"] = this.completeTask;
        data["id"] = this.id;
        return data; 
    }
}
...
export class CheckEmployee implements ICheckEmployee {
    name1: string;
    name2: string;

    constructor(data?: ICheckEmployee) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CheckEmployee {
        let result = new CheckEmployee();
        result.init(data);
        return result;
    }
...
export interface ICheckEmployee {
    name1: string;
    name2: string;
}
...
export class CreateTaskInput implements ICreateTaskInput {
    ...
    init(data?: any) {
        if (data) {
            ...
            this.dateStart = data["dateStart"] ? moment(data["dateStart"].toString()) : <any>undefined;
            this.dateEnd = data["dateEnd"] ? moment(data["dateEnd"].toString()) : <any>undefined;
            this.id = data["id"];
        }
    }
...
export class ListResultDtoOfTaskEmployeeDto implements IListResultDtoOfTaskEmployeeDto {
    items: TaskEmployeeDto[];

    constructor(data?: IListResultDtoOfTaskEmployeeDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            if (data["items"] && data["items"].constructor === Array) {
                this.items = [];
                for (let item of data["items"])
                    this.items.push(TaskEmployeeDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): ListResultDtoOfTaskEmployeeDto {
        let result = new ListResultDtoOfTaskEmployeeDto();
        result.init(data);
        return result;
    }
...
export interface IListResultDtoOfTaskEmployeeDto {
    items: TaskEmployeeDto[];
}

export class TaskEmployeeDto implements ITaskEmployeeDto {
    employeeId: number;
    name: string;
    state: TaskEmployeeDtoState;
    discription: string;
    tenanId: number;
    creationTime: moment.Moment;
    title: string;
    ...
    constructor(data?: ITaskEmployeeDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): TaskEmployeeDto {
        let result = new TaskEmployeeDto();
        result.init(data);
        return result;
    }
...
export interface ITaskEmployeeDto {
    employeeId: number;
    name: string;
    state: TaskEmployeeDtoState;
    discription: string;
...
export enum TaskEmployeeDtoState {
    _0 = 0, 
    _1 = 1, 
}
