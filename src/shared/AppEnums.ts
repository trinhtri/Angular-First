...
export class TaskState{
    // static Open:number=TaskListDtoState._0;
    // static Completed:number=TaskListDtoState._1;
    
     static Open:number=TaskEmployeeDtoState._0;
    static Completed:number=TaskEmployeeDtoState._1;
}
